...
class StudentManagerView(StudentManagerController):
    def __init__(self) :
        super().__init__()
    ...
    def output_students(self, stu_list):
...
if __name__ == "__main__":
    ...
    #     print(re.name,re.id)
    v01 = StudentManagerView()
    v01.inst_student()
    v01.output_students(v01.stu_list)
    pass